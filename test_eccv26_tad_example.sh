...
mkdir -p output
VOLUME_MOUNTPOINT=$(sudo docker volume inspect --format '{{ .Mountpoint }}' eccv26_tad_volume)
sudo rsync --delete -azvv "${VOLUME_MOUNTPOINT}/conda/envs/eccv26/lib/python3.10/site-packages/images_framework/output/images/" output
