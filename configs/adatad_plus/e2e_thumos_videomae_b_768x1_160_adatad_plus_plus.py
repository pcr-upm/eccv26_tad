...
model = dict(
    backbone=dict(
        ...
        backbone=dict(
            ...
            adapter_conv_type="adatad_plus_plus",  # the AdaTAD++ adapter
            adapter_deformable_groups=2, 
        ),
        ...
        custom=dict(
            pretrain="pretrained/vit-base-p16_videomae-k400-pre_16x4x1_kinetics-400_20221013-860a3cd3.pth",
    ...
    projection=dict(
        in_channels=768,  # matches the ViT-B embed_dims
...
workflow = dict(
    ...
    val_eval_interval=2,
    val_start_epoch=40,
    end_epoch=60,  # overrides the scheduler's max_epoch=100
)
