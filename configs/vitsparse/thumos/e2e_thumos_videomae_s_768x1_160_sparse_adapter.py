...
optimizer = dict(
    ...
    backbone=dict(
        ...
        weight_decay=0,
        custom=[
            dict(name="adapter", lr=0.0001, weight_decay=0.05),
            dict(name="cls_token", lr=0.0001, weight_decay=0.05),
        ],
        exclude=["backbone"],
    ),
)
...
work_dir = "exps/thumos/vitsparse/e2e_actionformer_videomae_s_768x1_160_sparse_adapter"