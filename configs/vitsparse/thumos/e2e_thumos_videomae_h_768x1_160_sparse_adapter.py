...
model = dict(
    backbone=dict(
        backbone=dict(
            ...
            keep_rate=0.4,
            adapter_conv_types=["2d_conv"] * 3 + ["sparse_conv"] * 29,
        ),
        custom=dict(pretrain="pretrained/videomaev2_huge_converted.pth"),
    ),
...
work_dir = "exps/thumos/vitsparse/e2e_actionformer_videomae_h_768x1_160_adapter"
