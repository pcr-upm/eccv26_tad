...
model = dict(
    backbone=dict(
        ...
        backbone=dict(
            ...
            keep_rate=0.7,
            # All layers: Frame2Freq-style temporal + multi-resolution
            # frequency (FFT) adapter (https://github.com/th-nesh/Frame2Freq).
            adapter_conv_types= ["freq_conv"] * 12,
            adapter_use_attn=3,
            n_landmarks=0,
        ),
...
work_dir = "exps/thumos/vitsparse/e2e_actionformer_videomae_s_768x1_160_freq_adapter"
