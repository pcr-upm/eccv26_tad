...
class ECCV26TAD(Recognition):
    ...
    def process(self, ann, pred):
        ...
        if self.database == 'thumos':
            class_map = ["BaseballPitch", "BasketballDunk", "Billiards", "CleanAndJerk", "CliffDiving", "CricketBowling", "CricketShot", "Diving", "FrisbeeCatch", "GolfSwing", "HammerThrow", "HighJump", "JavelinThrow", "LongJump", "PoleVault", "Shotput", "SoccerPenalty", "TennisSwing", "ThrowDiscus", "VolleyballSpiking"]
        else:
            raise ValueError('Database is not implemented')
